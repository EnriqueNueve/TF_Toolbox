...
Takes three arguments: --epochs (int > 0) --use_gpu (True/False)
Ex: python train_model.py --epochs 5 --use_gpu True
"""

USE_GPU = ['/GPU:0','/GPU:1','/GPU:2','/GPU:3',]
...
if __name__ == "__main__":
    ...
    if args.use_gpu == True:
        mirrored_strategy = tf.distribute.MirroredStrategy(USE_GPU)
        N_GPU = len(USE_GPU)
